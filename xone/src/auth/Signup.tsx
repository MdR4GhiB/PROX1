                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        <div className="flex flex-col lg:flex-row">
                                ...
                                <div className="max-w-sm mx-auto">
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm text-indigo-100">Free account setup</span>
                                        </div>
                                        <div className="flex items-center">
                                            <svg className="w-5 h-5 mr-2 text-indigo-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                            </svg>
                                            <span className="text-sm text-indigo-100">No credit card required</span>
                                        </div>
                                        <div className="flex items-center">
                                            <svg className="w-5 h-5 mr-2 text-indigo-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                            </svg>
                                            <span className="text-sm text-indigo-100">Cancel anytime</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-8 p-4 bg-indigo-700 bg-opacity-30 rounded-lg border border-indigo-500">
                                        ...
                                        <div className="mt-2 flex items-center">
                                            ...
                                            <div className="ml-2">
                                                ...
                                                <p className="text-xs text-indigo-200">New Member</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* Right Container - Signup Form (smaller) */}
                            <div className="lg:w-7/12 p-6 lg:p-8 bg-white">
                                <div className="max-w-sm mx-auto">
                                    {/* Mobile Welcome (visible only on mobile) */}
                                    <div className="lg:hidden text-center mb-6">
                                        <h1 className="text-2xl font-bold text-indigo-600 mb-1">Join Xone Today</h1>
